if(!window.UsersAPI) window.UsersAPI = {
    ...
    CreateUserGroup: function (params) {
        ...
        var url = UsersAPI.ResponseURL + "/CreateUserGroup?timeStamp=" + new Date().getTime();
        var queryString = (params.Name ? "&Name=" + params.Name : "");
        return UsersAPI._send(url, params, queryString);
    },

    RenameUserGroup: function (params) {
        params = params || {};

        var url = UsersAPI.ResponseURL + "/RenameUserGroup?timeStamp=" + new Date().getTime();
        var queryString = (params.ID ? "&ID=" + params.ID : "") +
            (params.Name ? "&Name=" + params.Name : "");
        return UsersAPI._send(url, params, queryString);
    },

    RemoveUserGroup: function (params) {
        params = params || {};

        var url = UsersAPI.ResponseURL + "/RemoveUserGroup?timeStamp=" + new Date().getTime();
        var queryString = (params.ID ? "&ID=" + params.ID : "");
        return UsersAPI._send(url, params, queryString);
    },
    ...
    GetUserGroups: function (params) {
        ...
        var url = UsersAPI.ResponseURL + "/GetUserGroups?timeStamp=" + new Date().getTime();
        return UsersAPI._send(url, params, "");
    },

    AddUserGroupMember: function (params) {
        params = params || {};

        var url = UsersAPI.ResponseURL + "/AddUserGroupMember?timeStamp=" + new Date().getTime();
        var queryString = (params.ID ? "&ID=" + params.ID : "") +
            (params.UserID ? "&UserID=" + params.UserID : "");
        return UsersAPI._send(url, params, queryString);
    },

    RemoveUserGroupMember: function (params) {
        params = params || {};

        var url = UsersAPI.ResponseURL + "/RemoveUserGroupMember?timeStamp=" + new Date().getTime();
        var queryString = (params.ID ? "&ID=" + params.ID : "") +
            (params.UserID ? "&UserID=" + params.UserID : "");
        return UsersAPI._send(url, params, queryString);
    },

    GetUserGroupMembers: function (params) {
        params = params || {};

        var url = UsersAPI.ResponseURL + "/GetUserGroupMembers?timeStamp=" + new Date().getTime();
        var queryString = (params.ID ? "&ID=" + params.ID : "");
        return UsersAPI._send(url, params, queryString);
    },

    GetAccessRoles: function (params) {
        params = params || {};

        var url = UsersAPI.ResponseURL + "/GetAccessRoles?timeStamp=" + new Date().getTime();
        return UsersAPI._send(url, params, "");
    },

    GetUserGroupPermissions: function (params) {
        params = params || {};

        var url = UsersAPI.ResponseURL + "/GetUserGroupPermissions?timeStamp=" + new Date().getTime();
        var queryString = (params.ID ? "&ID=" + params.ID : "");
        return UsersAPI._send(url, params, queryString);
    },

    SetUserGroupPermission: function (params) {
        params = params || {};

        var url = UsersAPI.ResponseURL + "/SetUserGroupPermission?timeStamp=" + new Date().getTime();
        var queryString = (params.ID ? "&ID=" + params.ID : "") +
            (params.GroupID ? "&GroupID=" + params.GroupID : "");
        return UsersAPI._send(url, params, queryString);
    },

    UnsetUserGroupPermission: function (params) {
        params = params || {};

        var url = UsersAPI.ResponseURL + "/UnsetUserGroupPermission?timeStamp=" + new Date().getTime();
        var queryString = (params.ID ? "&ID=" + params.ID : "") +
            (params.GroupID ? "&GroupID=" + params.GroupID : "");
        return UsersAPI._send(url, params, queryString);
    }
